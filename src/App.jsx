                    ...
                    <article className="group bg-card rounded-3xl overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-300 bg-gray-200 relative flex flex-col md:block h-full md:h-auto">
                      ...
                      <div className="relative aspect-square overflow-hidden">
                        <picture>
                          ...
                          <img src={srcOriginal} alt={producto.nombre} className={`absolute inset-0 w-full h-full transition-transform duration-500 ${(producto.categoria.toLowerCase().includes('funda') || producto.imgAll != null) ? 'object-cover p-0 scale-95 group-hover:scale-100' : 'object-contain p-6 group-hover:scale-105'}`} decoding="sync" loading="lazy" />
                        </picture>
                      </div>
